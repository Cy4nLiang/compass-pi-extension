...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
	...
	{ name: "compass_data_route", keywords: "route source freshness cost 数据 路由 新鲜度 补数 商品 查商品 listing ProductResearch 查品", description: "按阶段、字段、新鲜度和预算规划数据源" },
	{ name: "compass_gaps", keywords: "gap fill missing 缺口 缺数据 补数 缺失 字段 计划 清单 引导 数据 approve convert 确认 授权 转换 sorftime 付费 抓数 差评 评论 reviews 材料 asin 商品 查商品 listing ProductResearch 查品 mcp", description: "汇总选品数据缺口并给出按成本档分组的补数计划；确认后授权付费补数并把返回体转成可导入的 CSV" },
